...
**Last updated:** 2026-08-10 22:13 UTC  
...
| Benchmark | Median |
|-----------|--------|
| `transport_jsonrpc_send/single_message` | 1.64 ms |
| `transport_jsonrpc_stream/stream_drain` | 1.56 ms |
| `transport_payload_scaling/jsonrpc_send/1024` | 1.56 ms |
| `transport_payload_scaling/jsonrpc_send/102400` | 1.90 ms |
| `transport_payload_scaling/jsonrpc_send/1048576` | 4.19 ms |
| `transport_payload_scaling/jsonrpc_send/16384` | 1.57 ms |
| `transport_payload_scaling/jsonrpc_send/256` | 1.56 ms |
| `transport_payload_scaling/jsonrpc_send/4096` | 1.49 ms |
| `transport_payload_scaling/jsonrpc_send/64` | 1.50 ms |
| `transport_rest_send/single_message` | 1.51 ms |
| `transport_rest_stream/stream_drain` | 1.61 ms |
...
| `protocol_batch/serialize_tasks/1` | 418 ns |
...
| `protocol_jsonrpc_envelope/deserialize_request` | 827 ns |
| `protocol_jsonrpc_envelope/deserialize_response` | 1.8 µs |
| `protocol_jsonrpc_envelope/serialize_request` | 275 ns |
| `protocol_jsonrpc_envelope/serialize_response` | 477 ns |
| `protocol_payload_scaling/from_slice/1024` | 527 ns |
| `protocol_payload_scaling/from_slice/102400` | 21.5 µs |
| `protocol_payload_scaling/from_slice/1048576` | 231.3 µs |
| `protocol_payload_scaling/from_slice/16384` | 3.9 µs |
| `protocol_payload_scaling/from_slice/256` | 357 ns |
| `protocol_payload_scaling/from_slice/4096` | 1.2 µs |
| `protocol_payload_scaling/from_slice/64` | 322 ns |
| `protocol_payload_scaling/from_str/1024` | 458 ns |
| `protocol_payload_scaling/from_str/102400` | 17.6 µs |
| `protocol_payload_scaling/from_str/1048576` | 190.1 µs |
| `protocol_payload_scaling/from_str/16384` | 8.2 µs |
| `protocol_payload_scaling/from_str/256` | 323 ns |
| `protocol_payload_scaling/from_str/4096` | 960 ns |
| `protocol_payload_scaling/from_str/64` | 282 ns |
| `protocol_payload_scaling/ser_buffer/1024` | 511 ns |
| `protocol_payload_scaling/ser_buffer/102400` | 38.6 µs |
| `protocol_payload_scaling/ser_buffer/1048576` | 437.6 µs |
...
| `protocol_payload_scaling/ser_buffer/64` | 131 ns |
| `protocol_payload_scaling/to_vec/1024` | 634 ns |
| `protocol_payload_scaling/to_vec/102400` | 36.9 µs |
| `protocol_payload_scaling/to_vec/1048576` | 422.7 µs |
| `protocol_payload_scaling/to_vec/16384` | 6.1 µs |
| `protocol_payload_scaling/to_vec/256` | 349 ns |
| `protocol_payload_scaling/to_vec/4096` | 1.9 µs |
| `protocol_payload_scaling/to_vec/64` | 196 ns |
| `protocol_stream_events/artifact_update_deserialize` | 525 ns |
| `protocol_stream_events/artifact_update_serialize` | 242 ns |
| `protocol_stream_events/status_update_deserialize` | 359 ns |
| `protocol_stream_events/status_update_serialize` | 106 ns |
| `protocol_type_serde/agent_card_deserialize` | 1.3 µs |
| `protocol_type_serde/agent_card_serialize` | 534 ns |
...
| `protocol_type_serde/task_serialize/278` | 475 ns |
...
| Benchmark | Median |
|-----------|--------|
| `lifecycle_e2e/send_and_complete` | 1.70 ms |
| `lifecycle_e2e/stream_and_drain` | 2.16 ms |
| `lifecycle_queue/write_read/1` | 778 ns |
| `lifecycle_queue/write_read/10` | 4.4 µs |
| `lifecycle_queue/write_read/100` | 42.5 µs |
| `lifecycle_queue/write_read/50` | 21.6 µs |
| `lifecycle_store_get/lookup_in_1000` | 448 ns |
| `lifecycle_store_list/filtered_page_50_of_250` | 28.7 µs |
| `lifecycle_store_save/single_task` | 731 ns |
...
| `concurrent_sends/jsonrpc/1` | 1.59 ms |
| `concurrent_sends/jsonrpc/16` | 5.14 ms |
| `concurrent_sends/jsonrpc/4` | 4.35 ms |
| `concurrent_sends/jsonrpc/64` | 10.51 ms |
| `concurrent_store/save_and_get/1` | 35.7 µs |
| `concurrent_store/save_and_get/16` | 86.8 µs |
| `concurrent_store/save_and_get/4` | 31.4 µs |
| `concurrent_store/save_and_get/64` | 225.4 µs |
| `concurrent_streams/jsonrpc/1` | 1.49 ms |
| `concurrent_streams/jsonrpc/16` | 4.58 ms |
| `concurrent_streams/jsonrpc/4` | 3.63 ms |
| `concurrent_streams/jsonrpc/64` | 8.11 ms |
...
| `realistic_complex_card/deserialize/100` | 116.3 µs |
| `realistic_complex_card/deserialize/50` | 62.6 µs |
...
| `realistic_connection/new_client_per_request` | 1.70 ms |
| `realistic_connection/reused_client` | 1.47 ms |
...
| `realistic_history_serde/serialize/1` | 590 ns |
...
| `realistic_interceptor_chain/interceptors/0` | 182.4 µs |
| `realistic_interceptor_chain/interceptors/1` | 184.0 µs |
| `realistic_interceptor_chain/interceptors/10` | 185.2 µs |
| `realistic_interceptor_chain/interceptors/5` | 184.5 µs |
| `realistic_multi_turn/sequential/1` | 1.57 ms |
| `realistic_multi_turn/sequential/10` | 16.34 ms |
| `realistic_multi_turn/sequential/3` | 4.87 ms |
| `realistic_multi_turn/sequential/5` | 8.37 ms |
| `realistic_payload_complexity/large_metadata_10kb` | 2.73 ms |
| `realistic_payload_complexity/mixed_parts` | 1.64 ms |
| `realistic_payload_complexity/nested_metadata_10` | 1.78 ms |
...
| `errors_happy_vs_error/happy_path` | 1.51 ms |
| `errors_malformed_request/invalid_json` | 97.6 µs |
| `errors_malformed_request/wrong_content_type` | 97.9 µs |
| `errors_task_not_found/get_nonexistent_task` | 112.2 µs |
...
| Benchmark | Median |
|-----------|--------|
| `backpressure_concurrent_streams/streams/1` | 1.70 ms |
| `backpressure_concurrent_streams/streams/16` | 4.59 ms |
| `backpressure_concurrent_streams/streams/4` | 3.83 ms |
| `backpressure_slow_consumer/1ms_delay` | 30.46 ms |
| `backpressure_slow_consumer/5ms_delay` | 83.13 ms |
| `backpressure_slow_consumer/fast_consumer` | 1.77 ms |
| `backpressure_stream_volume/252_events` | 15.29 ms |
| `backpressure_stream_volume/27_events` | 1.93 ms |
| `backpressure_stream_volume/3_events` | 1.72 ms |
| `backpressure_stream_volume/502_events` | 68.11 ms |
| `backpressure_stream_volume/52_events` | 795.3 µs |
| `backpressure_stream_volume/7_events` | 1.87 ms |
...
| `data_volume_concurrent_reads/get/16` | 40.7 µs |
| `data_volume_concurrent_reads/get/4` | 31.2 µs |
| `data_volume_concurrent_reads/get/64` | 81.8 µs |
| `data_volume_get/lookup/1000` | 428 ns |
...
| `data_volume_list/filtered_page_50/100000` | 26.6 µs |
...
| Benchmark | Value |
|-----------|-------|
| `memory_bytes_per_payload/serialize_bytes/1024` | 898 |
| `memory_bytes_per_payload/serialize_bytes/16384` | 11091 |
| `memory_bytes_per_payload/serialize_bytes/256` | 318 |
| `memory_bytes_per_payload/serialize_bytes/4096` | 2915 |
| `memory_bytes_per_payload/serialize_bytes/64` | 168 |
| `memory_deserialize/agent_card_alloc_count` | 1305 |
| `memory_deserialize/task_alloc_count` | 1051 |
| `memory_history_scaling/deserialize_allocs/1` | 1351 |
| `memory_history_scaling/deserialize_allocs/10` | 5145 |
| `memory_history_scaling/deserialize_allocs/20` | 10103 |
| `memory_history_scaling/deserialize_allocs/5` | 2928 |
| `memory_history_scaling/deserialize_allocs/50` | 23561 |
| `memory_history_scaling/serialize_allocs/1` | 544 |
| `memory_history_scaling/serialize_allocs/10` | 2438 |
| `memory_history_scaling/serialize_allocs/20` | 5674 |
| `memory_history_scaling/serialize_allocs/5` | 1390 |
| `memory_history_scaling/serialize_allocs/50` | 14025 |
| `memory_serialize/agent_card_alloc_count` | 495 |
| `memory_serialize/task_alloc_count` | 370 |
...
| Benchmark | Median |
|-----------|--------|
| `cross_language_concurrent_50/rust` | 9.47 ms |
| `cross_language_echo_roundtrip/rust` | 1.57 ms |
| `cross_language_minimal_overhead/rust` | 1.44 ms |
| `cross_language_serialize_agent_card/rust_deserialize` | 1.4 µs |
| `cross_language_serialize_agent_card/rust_roundtrip` | 2.0 µs |
| `cross_language_serialize_agent_card/rust_serialize` | 474 ns |
| `cross_language_stream_events/rust` | 1.79 ms |
...
| `enterprise_client_interceptors/interceptors/0` | 1.38 ms |
| `enterprise_client_interceptors/interceptors/1` | 1.49 ms |
...
| `enterprise_eviction/save_at_capacity/100` | 864 ns |
| `enterprise_eviction/save_at_capacity/1000` | 901 ns |
| `enterprise_eviction/save_at_capacity/10000` | 1.2 µs |
| `enterprise_eviction/sweep_duration/100` | 143 ns |
| `enterprise_eviction/sweep_duration/1000` | 146 ns |
| `enterprise_eviction/sweep_duration/10000` | 186 ns |
| `enterprise_handler_limits/default_limits` | 1.39 ms |
| `enterprise_handler_limits/metadata_rejection` | 130.0 µs |
| `enterprise_handler_limits/tight_limits` | 1.40 ms |
| `enterprise_large_history/deserialize/100` | 47.5 µs |
| `enterprise_large_history/deserialize/200` | 93.6 µs |
| `enterprise_large_history/deserialize/500` | 229.1 µs |
| `enterprise_large_history/serialize/100` | 19.4 µs |
| `enterprise_large_history/serialize/200` | 38.2 µs |
| `enterprise_large_history/serialize/500` | 92.2 µs |
| `enterprise_large_history/store_save/100` | 14.8 µs |
| `enterprise_large_history/store_save/200` | 32.0 µs |
| `enterprise_large_history/store_save/500` | 87.0 µs |
| `enterprise_list_tasks/page_size/10` | 189.9 µs |
| `enterprise_list_tasks/page_size/25` | 274.4 µs |
| `enterprise_list_tasks/page_size/50` | 398.2 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/1` | 35.0 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/10` | 51.4 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/100` | 181.8 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/50` | 112.6 µs |
...
| `enterprise_multi_tenant/tenant_isolation_check/50` | 489 ns |
| `enterprise_push_config/get` | 255 ns |
| `enterprise_push_config/list_per_task/1` | 203 ns |
...
| `enterprise_rate_limiting/no_rate_limit` | 1.44 ms |
| `enterprise_rate_limiting/with_rate_limit` | 1.48 ms |
| `enterprise_rw_mix/0r_100w` | 288.0 µs |
| `enterprise_rw_mix/100r_0w` | 63.0 µs |
| `enterprise_rw_mix/25r_75w` | 238.1 µs |
| `enterprise_rw_mix/50r_50w` | 185.4 µs |
| `enterprise_rw_mix/75r_25w` | 125.9 µs |
...
| Benchmark | Median |
|-----------|--------|
| `production_agent_burst/agents/10` | 6.80 ms |
| `production_agent_burst/agents/100` | 33.36 ms |
| `production_agent_burst/agents/50` | 19.13 ms |
| `production_cancel_subscribe_race/concurrent_cancel_and_subscribe` | 962.2 µs |
| `production_cold_start/first_request` | 341.5 µs |
| `production_cold_start/steady_state` | 1.52 ms |
| `production_dispatch_routing/direct_handler_invoke` | 1.36 ms |
| `production_dispatch_routing/full_http_roundtrip` | 1.41 ms |
| `production_e2e_orchestration/7_step_workflow` | 7.00 ms |
| `production_push_config/delete_roundtrip` | 227.3 µs |
| `production_push_config/get_roundtrip` | 110.9 µs |
| `production_push_config/list_roundtrip` | 119.5 µs |
| `production_push_config/set_roundtrip` | 114.7 µs |
...
| Benchmark | Median |
|-----------|--------|
| `advanced_agent_card_discovery/well_known_endpoint` | 94.1 µs |
| `advanced_agent_card_hot_reload/read_current_card` | 337 ns |
| `advanced_agent_card_hot_reload/swap_and_read` | 668 ns |
| `advanced_agent_card_hot_reload/swap_complex_card` | 59.7 µs |
| `advanced_artifact_accumulation/store_save_at_depth/0` | 618 ns |
...
| `advanced_artifact_accumulation/store_save_at_depth/500` | 69.5 µs |
...
| `advanced_extended_agent_card/get_extended_card_roundtrip` | 106.0 µs |
| `advanced_pagination_walk/filtered/1000_tasks_page_50` | 329.1 µs |
| `advanced_pagination_walk/filtered/100_tasks_page_25` | 31.8 µs |
| `advanced_pagination_walk/unfiltered/1000_tasks_page_50` | 640.0 µs |
| `advanced_pagination_walk/unfiltered/100_tasks_page_25` | 62.4 µs |
| `advanced_subscribe_fanout/concurrent_subscribers/1` | 1.99 ms |
| `advanced_subscribe_fanout/concurrent_subscribers/10` | 2.47 ms |
| `advanced_subscribe_fanout/concurrent_subscribers/5` | 2.16 ms |
...
| `advanced_tenant_resolver/path_resolver` | 178 ns |
