...
**Last updated:** 2026-09-22 19:32 UTC  
...
| Benchmark | Median |
|-----------|--------|
| `transport_jsonrpc_send/single_message` | 196.8 µs |
| `transport_jsonrpc_stream/stream_drain` | 204.2 µs |
| `transport_payload_scaling/jsonrpc_send/1024` | 192.7 µs |
| `transport_payload_scaling/jsonrpc_send/102400` | 482.9 µs |
| `transport_payload_scaling/jsonrpc_send/1048576` | 2.19 ms |
| `transport_payload_scaling/jsonrpc_send/16384` | 250.4 µs |
| `transport_payload_scaling/jsonrpc_send/256` | 195.2 µs |
| `transport_payload_scaling/jsonrpc_send/4096` | 207.5 µs |
| `transport_payload_scaling/jsonrpc_send/64` | 193.9 µs |
| `transport_rest_send/single_message` | 190.6 µs |
| `transport_rest_stream/stream_drain` | 199.7 µs |
...
| `protocol_batch/deserialize_tasks/10` | 13.7 µs |
| `protocol_batch/deserialize_tasks/100` | 141.2 µs |
| `protocol_batch/deserialize_tasks/50` | 71.1 µs |
| `protocol_batch/serialize_tasks/1` | 436 ns |
| `protocol_batch/serialize_tasks/10` | 3.6 µs |
| `protocol_batch/serialize_tasks/100` | 32.5 µs |
...
| `protocol_jsonrpc_envelope/serialize_request` | 266 ns |
| `protocol_jsonrpc_envelope/serialize_response` | 529 ns |
| `protocol_payload_scaling/from_slice/1024` | 525 ns |
| `protocol_payload_scaling/from_slice/102400` | 19.5 µs |
| `protocol_payload_scaling/from_slice/1048576` | 211.6 µs |
| `protocol_payload_scaling/from_slice/16384` | 3.3 µs |
| `protocol_payload_scaling/from_slice/256` | 362 ns |
| `protocol_payload_scaling/from_slice/4096` | 1.1 µs |
| `protocol_payload_scaling/from_slice/64` | 328 ns |
| `protocol_payload_scaling/from_str/1024` | 426 ns |
| `protocol_payload_scaling/from_str/102400` | 17.4 µs |
| `protocol_payload_scaling/from_str/1048576` | 189.7 µs |
| `protocol_payload_scaling/from_str/16384` | 8.1 µs |
| `protocol_payload_scaling/from_str/256` | 291 ns |
| `protocol_payload_scaling/from_str/4096` | 935 ns |
| `protocol_payload_scaling/from_str/64` | 263 ns |
| `protocol_payload_scaling/ser_buffer/1024` | 804 ns |
| `protocol_payload_scaling/ser_buffer/102400` | 68.5 µs |
| `protocol_payload_scaling/ser_buffer/1048576` | 726.8 µs |
| `protocol_payload_scaling/ser_buffer/16384` | 10.9 µs |
| `protocol_payload_scaling/ser_buffer/256` | 271 ns |
| `protocol_payload_scaling/ser_buffer/4096` | 2.8 µs |
| `protocol_payload_scaling/ser_buffer/64` | 153 ns |
| `protocol_payload_scaling/to_vec/1024` | 833 ns |
| `protocol_payload_scaling/to_vec/102400` | 66.4 µs |
| `protocol_payload_scaling/to_vec/1048576` | 691.5 µs |
| `protocol_payload_scaling/to_vec/16384` | 10.7 µs |
| `protocol_payload_scaling/to_vec/256` | 359 ns |
...
| `protocol_stream_events/artifact_update_serialize` | 227 ns |
| `protocol_stream_events/status_update_deserialize` | 360 ns |
| `protocol_stream_events/status_update_serialize` | 123 ns |
| `protocol_type_serde/agent_card_deserialize` | 1.4 µs |
| `protocol_type_serde/agent_card_serialize` | 623 ns |
| `protocol_type_serde/message_deserialize/217` | 693 ns |
| `protocol_type_serde/message_serialize/217` | 316 ns |
| `protocol_type_serde/task_deserialize/278` | 1.1 µs |
| `protocol_type_serde/task_serialize/278` | 440 ns |
...
| Benchmark | Median |
|-----------|--------|
| `lifecycle_e2e/send_and_complete` | 196.2 µs |
| `lifecycle_e2e/stream_and_drain` | 249.5 µs |
| `lifecycle_queue/write_read/1` | 795 ns |
| `lifecycle_queue/write_read/10` | 4.7 µs |
| `lifecycle_queue/write_read/100` | 45.5 µs |
| `lifecycle_queue/write_read/50` | 22.7 µs |
...
| Benchmark | Median |
|-----------|--------|
| `concurrent_mixed/send_then_get` | 313.6 µs |
| `concurrent_sends/jsonrpc/1` | 198.5 µs |
| `concurrent_sends/jsonrpc/16` | 1.57 ms |
| `concurrent_sends/jsonrpc/4` | 478.7 µs |
| `concurrent_sends/jsonrpc/64` | 5.34 ms |
| `concurrent_store/save_and_get/1` | 36.0 µs |
| `concurrent_store/save_and_get/16` | 87.1 µs |
| `concurrent_store/save_and_get/4` | 31.8 µs |
| `concurrent_store/save_and_get/64` | 227.0 µs |
| `concurrent_streams/jsonrpc/1` | 253.4 µs |
| `concurrent_streams/jsonrpc/16` | 1.15 ms |
| `concurrent_streams/jsonrpc/4` | 395.9 µs |
| `concurrent_streams/jsonrpc/64` | 4.51 ms |
...
| `realistic_complex_card/deserialize/100` | 115.7 µs |
| `realistic_complex_card/deserialize/50` | 59.4 µs |
| `realistic_complex_card/serialize/1` | 888 ns |
| `realistic_complex_card/serialize/10` | 3.3 µs |
| `realistic_complex_card/serialize/100` | 26.8 µs |
| `realistic_complex_card/serialize/50` | 13.7 µs |
| `realistic_connection/new_client_per_request` | 317.1 µs |
| `realistic_connection/reused_client` | 193.8 µs |
...
| `realistic_history_serde/deserialize/5` | 3.0 µs |
| `realistic_history_serde/deserialize/50` | 24.3 µs |
| `realistic_history_serde/serialize/1` | 522 ns |
...
| `realistic_history_serde/serialize/50` | 8.2 µs |
| `realistic_interceptor_chain/interceptors/0` | 183.3 µs |
| `realistic_interceptor_chain/interceptors/1` | 185.1 µs |
| `realistic_interceptor_chain/interceptors/10` | 185.2 µs |
| `realistic_interceptor_chain/interceptors/5` | 186.7 µs |
| `realistic_multi_turn/sequential/1` | 195.1 µs |
| `realistic_multi_turn/sequential/10` | 2.00 ms |
| `realistic_multi_turn/sequential/3` | 595.0 µs |
| `realistic_multi_turn/sequential/5` | 996.0 µs |
| `realistic_payload_complexity/large_metadata_10kb` | 374.6 µs |
| `realistic_payload_complexity/mixed_parts` | 213.4 µs |
| `realistic_payload_complexity/nested_metadata_10` | 234.1 µs |
| `realistic_payload_complexity/simple_text` | 196.1 µs |
...
| Benchmark | Median |
|-----------|--------|
| `errors_happy_vs_error/error_path` | 187.4 µs |
| `errors_happy_vs_error/happy_path` | 196.8 µs |
| `errors_malformed_request/invalid_json` | 95.5 µs |
| `errors_malformed_request/wrong_content_type` | 96.3 µs |
| `errors_task_not_found/get_nonexistent_task` | 108.4 µs |
...
| Benchmark | Median |
|-----------|--------|
| `backpressure_append_volume/discard_store_252_events` | 1.35 ms |
| `backpressure_append_volume/discard_store_27_events` | 360.8 µs |
| `backpressure_append_volume/discard_store_3_events` | 233.6 µs |
| `backpressure_append_volume/discard_store_502_events` | 2.44 ms |
| `backpressure_append_volume/discard_store_52_events` | 479.9 µs |
| `backpressure_append_volume/discard_store_7_events` | 259.5 µs |
| `backpressure_append_volume/sqlite_store_252_events` | 63.53 ms |
| `backpressure_append_volume/sqlite_store_27_events` | 7.77 ms |
| `backpressure_append_volume/sqlite_store_3_events` | 1.74 ms |
| `backpressure_append_volume/sqlite_store_502_events` | 122.98 ms |
| `backpressure_append_volume/sqlite_store_52_events` | 14.02 ms |
| `backpressure_append_volume/sqlite_store_7_events` | 2.72 ms |
| `backpressure_append_volume/task_store_252_events` | 1.60 ms |
| `backpressure_append_volume/task_store_27_events` | 426.6 µs |
| `backpressure_append_volume/task_store_3_events` | 250.4 µs |
| `backpressure_append_volume/task_store_502_events` | 2.89 ms |
| `backpressure_append_volume/task_store_52_events` | 579.5 µs |
| `backpressure_append_volume/task_store_7_events` | 284.5 µs |
| `backpressure_concurrent_streams/streams/1` | 318.9 µs |
| `backpressure_concurrent_streams/streams/16` | 1.65 ms |
| `backpressure_concurrent_streams/streams/4` | 520.4 µs |
| `backpressure_slow_consumer/1ms_delay` | 27.64 ms |
| `backpressure_slow_consumer/5ms_delay` | 80.42 ms |
| `backpressure_slow_consumer/fast_consumer` | 330.2 µs |
| `backpressure_stream_volume/252_events` | 1.70 ms |
| `backpressure_stream_volume/27_events` | 433.2 µs |
| `backpressure_stream_volume/3_events` | 249.7 µs |
| `backpressure_stream_volume/502_events` | 3.02 ms |
| `backpressure_stream_volume/52_events` | 591.3 µs |
| `backpressure_stream_volume/7_events` | 288.1 µs |
...
| `data_volume_concurrent_reads/get/16` | 39.7 µs |
| `data_volume_concurrent_reads/get/4` | 30.9 µs |
| `data_volume_concurrent_reads/get/64` | 79.1 µs |
| `data_volume_get/lookup/1000` | 448 ns |
| `data_volume_get/lookup/10000` | 447 ns |
| `data_volume_get/lookup/100000` | 205 ns |
| `data_volume_history_depth/save_with_turns/1` | 2.6 µs |
| `data_volume_history_depth/save_with_turns/10` | 7.3 µs |
| `data_volume_history_depth/save_with_turns/20` | 12.5 µs |
| `data_volume_history_depth/save_with_turns/5` | 4.1 µs |
| `data_volume_history_depth/save_with_turns/50` | 24.9 µs |
| `data_volume_list/filtered_page_50/1000` | 26.7 µs |
| `data_volume_list/filtered_page_50/10000` | 26.8 µs |
| `data_volume_list/filtered_page_50/100000` | 26.8 µs |
...
| Benchmark | Value |
|-----------|-------|
| `memory_bytes_per_payload/serialize_bytes/1024` | 862 |
| `memory_bytes_per_payload/serialize_bytes/16384` | 11104 |
| `memory_bytes_per_payload/serialize_bytes/256` | 320 |
| `memory_bytes_per_payload/serialize_bytes/4096` | 2909 |
| `memory_bytes_per_payload/serialize_bytes/64` | 186 |
| `memory_deserialize/agent_card_alloc_count` | 1363 |
| `memory_deserialize/task_alloc_count` | 1084 |
| `memory_history_scaling/deserialize_allocs/1` | 1343 |
| `memory_history_scaling/deserialize_allocs/10` | 5252 |
| `memory_history_scaling/deserialize_allocs/20` | 10125 |
| `memory_history_scaling/deserialize_allocs/5` | 2962 |
| `memory_history_scaling/deserialize_allocs/50` | 23614 |
| `memory_history_scaling/serialize_allocs/1` | 537 |
| `memory_history_scaling/serialize_allocs/10` | 2359 |
| `memory_history_scaling/serialize_allocs/20` | 5629 |
| `memory_history_scaling/serialize_allocs/5` | 1382 |
| `memory_history_scaling/serialize_allocs/50` | 13754 |
| `memory_serialize/agent_card_alloc_count` | 508 |
| `memory_serialize/task_alloc_count` | 362 |
...
| Benchmark | Median |
|-----------|--------|
| `cross_language_concurrent_50/rust` | 4.59 ms |
| `cross_language_echo_roundtrip/rust` | 192.1 µs |
| `cross_language_minimal_overhead/rust` | 183.9 µs |
| `cross_language_serialize_agent_card/rust_deserialize` | 1.3 µs |
| `cross_language_serialize_agent_card/rust_roundtrip` | 1.9 µs |
| `cross_language_serialize_agent_card/rust_serialize` | 468 ns |
| `cross_language_stream_events/rust` | 248.9 µs |
...
| Benchmark | Median |
|-----------|--------|
| `enterprise_cancel_task/send_then_cancel` | 317.3 µs |
| `enterprise_client_interceptors/interceptors/0` | 192.7 µs |
| `enterprise_client_interceptors/interceptors/1` | 194.9 µs |
| `enterprise_client_interceptors/interceptors/10` | 193.0 µs |
| `enterprise_client_interceptors/interceptors/5` | 193.4 µs |
| `enterprise_cors/options_preflight` | 86.4 µs |
| `enterprise_eviction/save_at_capacity/100` | 934 ns |
| `enterprise_eviction/save_at_capacity/1000` | 975 ns |
| `enterprise_eviction/save_at_capacity/10000` | 1.3 µs |
| `enterprise_eviction/sweep_duration/100` | 161 ns |
| `enterprise_eviction/sweep_duration/1000` | 162 ns |
| `enterprise_eviction/sweep_duration/10000` | 187 ns |
| `enterprise_handler_limits/default_limits` | 194.3 µs |
| `enterprise_handler_limits/metadata_rejection` | 126.6 µs |
| `enterprise_handler_limits/tight_limits` | 194.5 µs |
| `enterprise_large_history/deserialize/100` | 48.2 µs |
| `enterprise_large_history/deserialize/200` | 94.4 µs |
| `enterprise_large_history/deserialize/500` | 229.5 µs |
| `enterprise_large_history/serialize/100` | 15.1 µs |
| `enterprise_large_history/serialize/200` | 31.3 µs |
| `enterprise_large_history/serialize/500` | 82.6 µs |
| `enterprise_large_history/store_save/100` | 15.3 µs |
| `enterprise_large_history/store_save/200` | 29.0 µs |
| `enterprise_large_history/store_save/500` | 83.2 µs |
| `enterprise_list_tasks/page_size/10` | 184.3 µs |
| `enterprise_list_tasks/page_size/25` | 269.0 µs |
| `enterprise_list_tasks/page_size/50` | 382.2 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/1` | 35.8 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/10` | 50.3 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/100` | 184.5 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/50` | 109.2 µs |
| `enterprise_multi_tenant/tenant_isolation_check/1` | 508 ns |
| `enterprise_multi_tenant/tenant_isolation_check/10` | 515 ns |
| `enterprise_multi_tenant/tenant_isolation_check/100` | 512 ns |
| `enterprise_multi_tenant/tenant_isolation_check/50` | 516 ns |
| `enterprise_push_config/get` | 256 ns |
...
| `enterprise_rate_limiting/no_rate_limit` | 193.2 µs |
| `enterprise_rate_limiting/with_rate_limit` | 194.3 µs |
| `enterprise_rw_mix/0r_100w` | 292.8 µs |
| `enterprise_rw_mix/100r_0w` | 62.9 µs |
| `enterprise_rw_mix/25r_75w` | 239.8 µs |
| `enterprise_rw_mix/50r_50w` | 189.4 µs |
| `enterprise_rw_mix/75r_25w` | 126.5 µs |
...
| Benchmark | Median |
|-----------|--------|
| `production_agent_burst/agents/10` | 3.52 ms |
| `production_agent_burst/agents/100` | 34.26 ms |
| `production_agent_burst/agents/50` | 17.02 ms |
| `production_agent_burst_client_sharing/per_agent_client_agents/10` | 3.51 ms |
| `production_agent_burst_client_sharing/per_agent_client_agents/100` | 34.41 ms |
| `production_agent_burst_client_sharing/per_agent_client_agents/50` | 17.06 ms |
| `production_agent_burst_client_sharing/shared_client_agents/10` | 3.14 ms |
| `production_agent_burst_client_sharing/shared_client_agents/100` | 29.39 ms |
| `production_agent_burst_client_sharing/shared_client_agents/50` | 14.63 ms |
| `production_cancel_subscribe_race/concurrent_cancel_and_subscribe` | 870.6 µs |
| `production_cold_start/first_request` | 342.7 µs |
| `production_cold_start/steady_state` | 194.0 µs |
| `production_dispatch_routing/direct_handler_invoke` | 70.6 µs |
| `production_dispatch_routing/full_http_roundtrip` | 195.0 µs |
| `production_e2e_orchestration/7_step_workflow` | 1.55 ms |
| `production_push_config/delete_roundtrip` | 223.7 µs |
| `production_push_config/get_roundtrip` | 108.0 µs |
| `production_push_config/list_roundtrip` | 114.4 µs |
| `production_push_config/set_roundtrip` | 113.8 µs |
| `production_subscribe_to_task/send_then_subscribe` | 345.0 µs |
...
| Benchmark | Median |
|-----------|--------|
| `advanced_agent_card_discovery/well_known_endpoint` | 90.3 µs |
| `advanced_agent_card_hot_reload/read_current_card` | 312 ns |
| `advanced_agent_card_hot_reload/swap_and_read` | 663 ns |
| `advanced_agent_card_hot_reload/swap_complex_card` | 62.7 µs |
| `advanced_artifact_accumulation/store_save_at_depth/0` | 682 ns |
...
| `advanced_artifact_accumulation/store_save_at_depth/500` | 70.9 µs |
...
| `advanced_artifact_accumulation/task_clone_at_depth/500` | 67.6 µs |
| `advanced_extended_agent_card/get_extended_card_roundtrip` | 105.1 µs |
| `advanced_pagination_walk/filtered/1000_tasks_page_50` | 330.9 µs |
| `advanced_pagination_walk/filtered/100_tasks_page_25` | 32.2 µs |
| `advanced_pagination_walk/unfiltered/1000_tasks_page_50` | 653.0 µs |
| `advanced_pagination_walk/unfiltered/100_tasks_page_25` | 67.6 µs |
| `advanced_subscribe_fanout/concurrent_subscribers/1` | 628.1 µs |
| `advanced_subscribe_fanout/concurrent_subscribers/10` | 1.07 ms |
| `advanced_subscribe_fanout/concurrent_subscribers/5` | 783.6 µs |
| `advanced_tenant_resolver/bearer_resolver` | 127 ns |
| `advanced_tenant_resolver/bearer_resolver_with_mapper` | 153 ns |
| `advanced_tenant_resolver/header_resolver` | 133 ns |
| `advanced_tenant_resolver/header_resolver_miss` | 89 ns |
| `advanced_tenant_resolver/path_resolver` | 171 ns |
...
Transport benchmarks (64B → 16KB) show a 29.1% latency increase for a
256× payload increase, because the 193.9 µs HTTP round-trip dominates. Serde
...
Connection reuse saves 123.3 µs (38.9%) on loopback —
317.1 µs per request when the client is rebuilt each time,
versus 193.8 µs when it is shared. On real networks with TLS the
...
- A benchmark that builds a client inside its measured region is measuring
  ...
  317.1 µs — the rebuild-every-time number — rather than
...
|---|---|---|---|
| 10 | 351.2 µs | 314.1 µs | 37.2 µs (10.6%) |
| 50 | 341.2 µs | 292.7 µs | 48.5 µs (14.2%) |
| 100 | 344.1 µs | 293.9 µs | 50.2 µs (14.6%) |
...
50.2 µs (14.6%) per agent
against the 123.3 µs (38.9%) that
