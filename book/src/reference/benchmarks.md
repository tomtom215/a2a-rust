...
**Last updated:** 2026-05-25 14:53 UTC  
...
| `transport_payload_scaling/jsonrpc_send/102400` | 1.82 ms |
| `transport_payload_scaling/jsonrpc_send/1048576` | 4.04 ms |
| `transport_payload_scaling/jsonrpc_send/16384` | 1.58 ms |
...
| `transport_rest_send/single_message` | 1.43 ms |
| `transport_rest_stream/stream_drain` | 1.46 ms |
...
| `protocol_batch/deserialize_tasks/50` | 68.1 µs |
| `protocol_batch/serialize_tasks/1` | 433 ns |
| `protocol_batch/serialize_tasks/10` | 3.5 µs |
| `protocol_batch/serialize_tasks/100` | 32.1 µs |
| `protocol_batch/serialize_tasks/50` | 16.4 µs |
| `protocol_jsonrpc_envelope/deserialize_request` | 798 ns |
| `protocol_jsonrpc_envelope/deserialize_response` | 1.7 µs |
| `protocol_jsonrpc_envelope/serialize_request` | 277 ns |
| `protocol_jsonrpc_envelope/serialize_response` | 508 ns |
| `protocol_payload_scaling/from_slice/1024` | 520 ns |
| `protocol_payload_scaling/from_slice/102400` | 21.7 µs |
| `protocol_payload_scaling/from_slice/1048576` | 206.7 µs |
| `protocol_payload_scaling/from_slice/16384` | 3.4 µs |
| `protocol_payload_scaling/from_slice/256` | 399 ns |
| `protocol_payload_scaling/from_slice/4096` | 1.1 µs |
| `protocol_payload_scaling/from_slice/64` | 348 ns |
| `protocol_payload_scaling/from_str/1024` | 428 ns |
| `protocol_payload_scaling/from_str/102400` | 17.5 µs |
| `protocol_payload_scaling/from_str/1048576` | 183.6 µs |
| `protocol_payload_scaling/from_str/16384` | 3.0 µs |
| `protocol_payload_scaling/from_str/256` | 300 ns |
| `protocol_payload_scaling/from_str/4096` | 938 ns |
| `protocol_payload_scaling/from_str/64` | 276 ns |
| `protocol_payload_scaling/ser_buffer/1024` | 798 ns |
| `protocol_payload_scaling/ser_buffer/102400` | 68.3 µs |
| `protocol_payload_scaling/ser_buffer/1048576` | 720.4 µs |
| `protocol_payload_scaling/ser_buffer/16384` | 11.0 µs |
...
| `protocol_payload_scaling/to_vec/1024` | 857 ns |
| `protocol_payload_scaling/to_vec/102400` | 66.3 µs |
| `protocol_payload_scaling/to_vec/1048576` | 696.1 µs |
| `protocol_payload_scaling/to_vec/16384` | 11.0 µs |
| `protocol_payload_scaling/to_vec/256` | 365 ns |
| `protocol_payload_scaling/to_vec/4096` | 2.8 µs |
| `protocol_payload_scaling/to_vec/64` | 180 ns |
| `protocol_stream_events/artifact_update_deserialize` | 512 ns |
| `protocol_stream_events/artifact_update_serialize` | 239 ns |
| `protocol_stream_events/status_update_deserialize` | 368 ns |
| `protocol_stream_events/status_update_serialize` | 122 ns |
| `protocol_type_serde/agent_card_deserialize` | 1.4 µs |
| `protocol_type_serde/agent_card_serialize` | 608 ns |
| `protocol_type_serde/message_deserialize/217` | 676 ns |
| `protocol_type_serde/message_serialize/217` | 289 ns |
| `protocol_type_serde/task_deserialize/278` | 1.1 µs |
| `protocol_type_serde/task_serialize/278` | 502 ns |
...
| Benchmark | Median |
|-----------|--------|
| `lifecycle_e2e/send_and_complete` | 1.59 ms |
| `lifecycle_e2e/stream_and_drain` | 1.76 ms |
| `lifecycle_queue/write_read/1` | 821 ns |
| `lifecycle_queue/write_read/10` | 4.6 µs |
| `lifecycle_queue/write_read/100` | 44.6 µs |
| `lifecycle_queue/write_read/50` | 21.6 µs |
| `lifecycle_store_get/lookup_in_1000` | 437 ns |
| `lifecycle_store_list/filtered_page_50_of_250` | 26.4 µs |
| `lifecycle_store_save/single_task` | 478 ns |
...
| `concurrent_sends/jsonrpc/16` | 4.36 ms |
| `concurrent_sends/jsonrpc/4` | 3.65 ms |
| `concurrent_sends/jsonrpc/64` | 8.08 ms |
| `concurrent_store/save_and_get/1` | 34.7 µs |
| `concurrent_store/save_and_get/16` | 71.9 µs |
| `concurrent_store/save_and_get/4` | 29.8 µs |
| `concurrent_store/save_and_get/64` | 197.7 µs |
| `concurrent_streams/jsonrpc/1` | 1.45 ms |
| `concurrent_streams/jsonrpc/16` | 4.39 ms |
| `concurrent_streams/jsonrpc/4` | 3.34 ms |
| `concurrent_streams/jsonrpc/64` | 8.89 ms |
...
| `realistic_complex_card/deserialize/100` | 113.2 µs |
...
| `realistic_complex_card/serialize/50` | 16.8 µs |
...
| `realistic_history_serde/serialize/1` | 604 ns |
...
| `realistic_interceptor_chain/interceptors/0` | 180.9 µs |
| `realistic_interceptor_chain/interceptors/1` | 181.0 µs |
| `realistic_interceptor_chain/interceptors/10` | 182.4 µs |
| `realistic_interceptor_chain/interceptors/5` | 182.3 µs |
| `realistic_multi_turn/sequential/1` | 1.49 ms |
| `realistic_multi_turn/sequential/10` | 15.17 ms |
| `realistic_multi_turn/sequential/3` | 4.67 ms |
| `realistic_multi_turn/sequential/5` | 7.61 ms |
...
| `realistic_payload_complexity/simple_text` | 1.51 ms |
...
| Benchmark | Median |
|-----------|--------|
| `errors_happy_vs_error/error_path` | 1.38 ms |
| `errors_happy_vs_error/happy_path` | 1.45 ms |
| `errors_malformed_request/invalid_json` | 103.4 µs |
| `errors_malformed_request/wrong_content_type` | 100.6 µs |
| `errors_task_not_found/get_nonexistent_task` | 112.7 µs |
...
| `backpressure_concurrent_streams/streams/16` | 4.26 ms |
| `backpressure_concurrent_streams/streams/4` | 3.32 ms |
| `backpressure_slow_consumer/1ms_delay` | 29.36 ms |
| `backpressure_slow_consumer/5ms_delay` | 82.16 ms |
| `backpressure_slow_consumer/fast_consumer` | 1.65 ms |
| `backpressure_stream_volume/252_events` | 9.92 ms |
| `backpressure_stream_volume/27_events` | 1.82 ms |
| `backpressure_stream_volume/3_events` | 1.49 ms |
| `backpressure_stream_volume/502_events` | 51.79 ms |
...
| `data_volume_concurrent_reads/get/64` | 81.5 µs |
| `data_volume_get/lookup/1000` | 441 ns |
...
| `data_volume_history_depth/save_with_turns/10` | 6.8 µs |
| `data_volume_history_depth/save_with_turns/20` | 11.4 µs |
| `data_volume_history_depth/save_with_turns/5` | 3.4 µs |
| `data_volume_history_depth/save_with_turns/50` | 25.0 µs |
...
| Benchmark | Value |
|-----------|-------|
| `memory_bytes_per_payload/serialize_bytes/1024` | 571 |
| `memory_bytes_per_payload/serialize_bytes/16384` | 6390 |
| `memory_bytes_per_payload/serialize_bytes/256` | 251 |
| `memory_bytes_per_payload/serialize_bytes/4096` | 1781 |
| `memory_bytes_per_payload/serialize_bytes/64` | 148 |
| `memory_deserialize/agent_card_alloc_count` | 1341 |
| `memory_deserialize/task_alloc_count` | 1031 |
| `memory_history_scaling/deserialize_allocs/1` | 1335 |
| `memory_history_scaling/deserialize_allocs/10` | 5079 |
| `memory_history_scaling/deserialize_allocs/20` | 10194 |
| `memory_history_scaling/deserialize_allocs/5` | 2934 |
| `memory_history_scaling/deserialize_allocs/50` | 23486 |
| `memory_history_scaling/serialize_allocs/1` | 558 |
| `memory_history_scaling/serialize_allocs/10` | 2075 |
| `memory_history_scaling/serialize_allocs/20` | 5117 |
| `memory_history_scaling/serialize_allocs/5` | 1198 |
| `memory_history_scaling/serialize_allocs/50` | 12641 |
...
| Benchmark | Median |
|-----------|--------|
| `cross_language_concurrent_50/rust` | 6.68 ms |
...
| `cross_language_serialize_agent_card/rust_serialize` | 518 ns |
...
| `enterprise_client_interceptors/interceptors/0` | 1.36 ms |
...
| `enterprise_cors/options_preflight` | 84.5 µs |
| `enterprise_eviction/save_at_capacity/100` | 536 ns |
| `enterprise_eviction/save_at_capacity/1000` | 585 ns |
| `enterprise_eviction/save_at_capacity/10000` | 885 ns |
...
| `enterprise_handler_limits/metadata_rejection` | 129.9 µs |
| `enterprise_handler_limits/tight_limits` | 1.38 ms |
| `enterprise_large_history/deserialize/100` | 47.8 µs |
| `enterprise_large_history/deserialize/200` | 94.2 µs |
| `enterprise_large_history/deserialize/500` | 231.0 µs |
| `enterprise_large_history/serialize/100` | 16.1 µs |
| `enterprise_large_history/serialize/200` | 31.5 µs |
| `enterprise_large_history/serialize/500` | 79.0 µs |
| `enterprise_large_history/store_save/100` | 15.8 µs |
| `enterprise_large_history/store_save/200` | 32.4 µs |
| `enterprise_large_history/store_save/500` | 89.7 µs |
| `enterprise_list_tasks/page_size/10` | 154.3 µs |
| `enterprise_list_tasks/page_size/25` | 190.2 µs |
| `enterprise_list_tasks/page_size/50` | 248.9 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/1` | 34.4 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/10` | 44.8 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/100` | 149.3 µs |
| `enterprise_multi_tenant/concurrent_tenant_saves/50` | 91.0 µs |
...
| `enterprise_rw_mix/0r_100w` | 241.9 µs |
| `enterprise_rw_mix/100r_0w` | 63.9 µs |
| `enterprise_rw_mix/25r_75w` | 211.3 µs |
| `enterprise_rw_mix/50r_50w` | 166.7 µs |
| `enterprise_rw_mix/75r_25w` | 116.6 µs |
...
| Benchmark | Median |
|-----------|--------|
| `production_agent_burst/agents/10` | 5.24 ms |
| `production_agent_burst/agents/100` | 26.63 ms |
| `production_agent_burst/agents/50` | 15.50 ms |
| `production_cancel_subscribe_race/concurrent_cancel_and_subscribe` | 850.5 µs |
| `production_cold_start/first_request` | 339.9 µs |
...
| `production_e2e_orchestration/7_step_workflow` | 6.28 ms |
| `production_push_config/delete_roundtrip` | 229.4 µs |
| `production_push_config/get_roundtrip` | 113.4 µs |
| `production_push_config/list_roundtrip` | 113.6 µs |
| `production_push_config/set_roundtrip` | 113.4 µs |
...
| Benchmark | Median |
|-----------|--------|
| `advanced_agent_card_discovery/well_known_endpoint` | 95.3 µs |
...
| `advanced_artifact_accumulation/store_save_at_depth/0` | 405 ns |
...
| `advanced_artifact_accumulation/task_clone_at_depth/500` | 68.4 µs |
| `advanced_extended_agent_card/get_extended_card_roundtrip` | 125.8 µs |
| `advanced_pagination_walk/filtered/1000_tasks_page_50` | 305.6 µs |
| `advanced_pagination_walk/filtered/100_tasks_page_25` | 29.4 µs |
| `advanced_pagination_walk/unfiltered/1000_tasks_page_50` | 580.1 µs |
| `advanced_pagination_walk/unfiltered/100_tasks_page_25` | 59.2 µs |
| `advanced_subscribe_fanout/concurrent_subscribers/1` | 1.96 ms |
| `advanced_subscribe_fanout/concurrent_subscribers/10` | 2.37 ms |
...
| `advanced_tenant_resolver/path_resolver` | 176 ns |
