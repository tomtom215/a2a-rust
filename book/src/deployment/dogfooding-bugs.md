...
Eight dogfooding passes across `v0.1.0` and `v0.2.0` uncovered **36 real bugs** that 950+ unit tests, integration tests, property tests, and fuzz tests did not catch. All 36 have been fixed.
