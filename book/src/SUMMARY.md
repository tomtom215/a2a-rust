...
- [Transport Layers](./concepts/transport-layers.md)
- [Agent Cards & Discovery](./concepts/agent-cards.md)
- [Tasks & Messages](./concepts/tasks-and-messages.md)
- [Streaming with SSE](./concepts/streaming.md)

# Building Agents

- [The AgentExecutor Trait](./building-agents/executor.md)
- [Request Handler & Builder](./building-agents/handler.md)
- [Dispatchers (JSON-RPC & REST)](./building-agents/dispatchers.md)
