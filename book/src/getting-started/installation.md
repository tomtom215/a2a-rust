...
```toml
[dependencies]
a2a-protocol-sdk = { version = "0.13", features = ["tracing", "signing"] }

# Or with individual crates:
a2a-protocol-server = { version = "0.13", features = ["tracing", "sqlite"] }
a2a-protocol-client = { version = "0.13", features = ["tls-rustls"] }
```
