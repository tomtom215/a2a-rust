...
| Protocol headers in responses | ✅ Done | REST operation responses include `A2A-Version: 1.0` and `Content-Type: application/a2a+json` (spec §3.6/§11.1; `application/json` until 2026-09-25, from a stale §11.1; both accepted on ingress). |
