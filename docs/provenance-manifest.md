...
**Measured 2026-09-10 at `20629c0`. Regenerate with `scripts/provenance_manifest.sh`.**
...
> passes the project's own DCO gate is **46.4%** (41.4% at 0.11.0, 19.4% at
...
At `20629c0`, **1104 commits**, spanning **2026-03-15 to 2026-09-10**.

| | Commits |
|---|---:|
| Total reachable | 1104 |
| Merge commits (`dco.yml` does not examine these) | 112 |
| **Non-merge commits — the population `dco.yml` grades** | **992** |

Git author field, all 1104 commits:

| Author | Commits |
|---|---:|
| `Claude <noreply@anthropic.com>` | 478 |
| `Tom F. <tomf@tomtomtech.net>` | 461 |
...
Applying `dco.yml`'s rules to all 992 non-merge commits:

| Outcome | Commits | Share |
|---|---:|---:|
| **Would pass** — human author, matching `Signed-off-by` | **460** | 46.4% |
| Fail — author `noreply@anthropic.com` | 477 | 48.1% |
| Fail — author `github-actions[bot]` | 39 | 3.9% |
...
`v0.7.0`) is where `PROVENANCE.md` §3.2 took effect. Of the **496 commits since**,
**zero** are AI-authored:

| Author, `b416c1a..20629c0` | Commits |
|---|---:|
| `Tom F. <tomf@tomtomtech.net>` | 461 |
...
Amending it changes its SHA, and therefore the SHA of all 1103 descendants.

| | |
|---|---|
| Commits whose SHA changes | **1104 — all of them** |
