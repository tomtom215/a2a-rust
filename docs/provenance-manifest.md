...
**Measured 2026-09-10 at `7406341`. Regenerate with `scripts/provenance_manifest.sh`.**
...
> passes the project's own DCO gate is **45.8%** (41.4% at 0.11.0, 19.4% at
...
At `7406341`, **1094 commits**, spanning **2026-03-15 to 2026-09-10**.

| | Commits |
|---|---:|
| Total reachable | 1094 |
| Merge commits (`dco.yml` does not examine these) | 112 |
| **Non-merge commits — the population `dco.yml` grades** | **982** |

Git author field, all 1094 commits:

| Author | Commits |
|---|---:|
| `Claude <noreply@anthropic.com>` | 478 |
| `Tom F. <tomf@tomtomtech.net>` | 451 |
...
Applying `dco.yml`'s rules to all 982 non-merge commits:

| Outcome | Commits | Share |
|---|---:|---:|
| **Would pass** — human author, matching `Signed-off-by` | **450** | 45.8% |
| Fail — author `noreply@anthropic.com` | 477 | 48.6% |
...
`v0.7.0`) is where `PROVENANCE.md` §3.2 took effect. Of the **486 commits since**,
**zero** are AI-authored:

| Author, `b416c1a..7406341` | Commits |
|---|---:|
| `Tom F. <tomf@tomtomtech.net>` | 451 |
...
Amending it changes its SHA, and therefore the SHA of all 1093 descendants.

| | |
|---|---|
| Commits whose SHA changes | **1094 — all of them** |
